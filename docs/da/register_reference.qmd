...
subtitle: "Bekræftede kolonnenavne for de hyppigst brugte DST-registre"
date: last-modified
format:
  html:
    toc: true
...
::: {.callout-note}
**Join-nøgler:**
BEF, DODSAARS, VNDS, LMDB, UDDA, AKM joines alle på `pnr`.
...
| Projekt-specifikke registre | Se projektvejledning | `pnr` | Varierer | [DARTER: se registersti →](darter/registersti-datastores.qmd) |
...
[DARTER — Registersti og datastores →](darter/registersti-datastores.qmd)
:::
