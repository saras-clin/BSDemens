...
```r
# KORREKT — erstat stien med din projekts parquet-mappe
# DARTER: load_database("dodsaars") %>% rename_with(tolower)
dod <- open_dataset("E:/workdata/[projektnummer]/cleaned-data/parquet-registers/dodsaars/") %>%
...
lmdb <- open_dataset("E:/workdata/[projektnummer]/cleaned-data/parquet-registers/lmdb/") %>%
...
deaths <- open_dataset("E:/workdata/[projektnummer]/cleaned-data/parquet-registers/dodsaars/") %>%
  rename_with(tolower) %>%                         # DARTER: load_database("dodsaars") %>% rename_with(tolower)
  filter(pnr %in% !!kohort_pnrs) %>%
