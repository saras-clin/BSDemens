...
| `\|>` | Send resultatet videre til næste funktion (pipen) | `df \|> filter(alder > 50) \|> select(pnr)` |
...
`collect()` forklares grundigt i [Fase 5 — Det universelle mønster](05_parquet-arrow-duckdb.qmd).
