...
- Sektionsoverskrifter med **CTRL+SHIFT+R** — de vises i script-navne-listen til venstre i editoren
- En kommentar per substantiel kodelinje (dette er påkrævet i dette projekt — se `CLAUDE.md`)
