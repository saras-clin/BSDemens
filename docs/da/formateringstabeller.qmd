...
Kender du ikke joins endnu, læs [Joins og pivots](joins-og-pivots.qmd) først.
:::
...
- [Socioøkonomiske variable](socioekonomiske-variable.qmd) — komplet kodeeksempel med AKM, FAIK og UDDA
- [SEPLINE](sepline.qmd) — guidelines til kategorisering af SES-variable
