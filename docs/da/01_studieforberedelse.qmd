...
**Kovariater**
Variable du inkluderer for at tage højde for confounding — faktorer der påvirker både eksponering og udfald.
...
En komplet beskrivelse af alle registre med kolonnenavne og join-nøgler finder du i [Fase 8 — Registerreference →](08_register_reference.qmd)
...
- **Ny R-bruger?** → [Fase 2 — R: det allermest nødvendige](02a_r-intro.qmd)
- **Klar til DST-serveren?** → [Fase 3 — Log ind på DST](03_getting-started-dst.qmd)
