...
## 4. Sammenligningskohorten (komparator) {#sammenligningskohorten-komparator}
...
- **Eligibilitet ved index.** Komparatoren skal være "i risiko" og opfylde inklusionskriterierne på sin index-dato — ellers risikerer du *immortal time bias* (en skævvridning der opstår, når en person tildeles eksponeringstid, hvori de per definition ikke kunne have fået udfaldet endnu).
...
→ Et kodeskelet til matching og studiepopulationsbygning ligger i [Fase 10 — Byg din studiepopulation](10_data-manipulation.qmd#byg-din-studiepopulation).
