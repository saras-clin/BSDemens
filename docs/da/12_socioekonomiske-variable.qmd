...
- [Fase 14 — Formateringstabeller](14b_formateringstabeller.qmd) — DST's SAS-filer til label-oversættelse
- [Fase 14 — Registerreference](14d_register_reference.qmd) — bekræftede kolonnenavne for AKM, FAIK og UDDA
...
- **Specialpakker** (OSDC til diabetesklassifikation, NMI til comorbiditetsscore, analyseværktøjer)? → [Fase 13 — Pakker og specialfunktioner](13a_pakker-oversigt.qmd)
- **Klar til at eksportere resultater?** → [Fase 15 — Eksport og hjemsendelse](15_eksport-hjemsendelse.qmd)
