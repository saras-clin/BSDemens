...
Du skriver stien til den parquet-mappe der indeholder registret — fx `open_dataset("sti/til/bef/")`. Hvilken sti det konkret er, afhænger af dit projekt og din server. Kolonnenavne for hvert register finder du i [13d — Registerreference](13d_register_reference.qmd).
