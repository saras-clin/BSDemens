...
→ [Studieforberedelse](../01_studieforberedelse.qmd)
→ [Kom i gang med R](../02a_r-intro.qmd)
→ [Kom i gang på DST](../03_getting-started-dst.qmd)
...
- [Registersti og datastores](01_registersti-datastores.qmd) — bekræftede stier til alle registre på 708421
